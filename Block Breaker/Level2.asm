...
;Blocks First Line
    ...
    b1 Bricks<2,30,20,80,30>
    b2 Bricks<2,95,20,145,30>   
    b3 Bricks<2,160,20,210,30>
    b4 Bricks<2,225,20,275,30>

;Blocks Second Line

    b5 Bricks<1,65,40,115,50>
    b6 Bricks<1,130,40,180,50>   
    b7 Bricks<1,195,40,245,50>

;Blocks Third Line

    b8 Bricks<2,95,60,145,70>   
    b9 Bricks<2,160,60,210,70>

;Blocks Fourth Line

    b10 Bricks<1,130,80,180,90> 
