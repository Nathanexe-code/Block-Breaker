...
;Blocks First Line
    ...
    b2 Bricks<3,95,20,145,30>   
    b3 Bricks<3,160,20,210,30>
    b4 Bricks<3,225,20,275,30>

;Blocks Second Line

    b5 Bricks<2,65,40,115,50>
    b6 Bricks<7,130,40,180,50>   
    b7 Bricks<2,195,40,245,50>
